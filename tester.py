...
class TestScaffold(AbstractTestScaffold):
    ...
    def setup(self, test_case):
        inputfile, solfile, srcfile = itemgetter("inputfile", "solfile", "srcfile")(
            test_case
        )
...
def generate_test_case_structure(
    cases, dir, category="", expect_failure=False, visible=lambda _: True
):
    fprefix = f"{dir}test"
    return [
        {
